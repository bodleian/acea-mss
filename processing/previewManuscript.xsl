...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
    ...
    xmlns:html="http://www.w3.org/1999/xhtml" xpath-default-namespace="http://www.tei-c.org/ns/1.0" exclude-result-prefixes="tei html xs" version="2.0">
    ...
    <xsl:variable name="website-url" as="xs:string" select="'https://acea.bodleian.ox.ac.uk'"/>
